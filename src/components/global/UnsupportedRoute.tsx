      ...
      <div className="flex flex-col text-gray-800 dark:text-gray-100 bg-white bg-opacity-60 dark:bg-slate-800 dark:bg-opacity-60 py-6 m-4 px-4 sm:px-12 my-[10vh] rounded-2xl max-w-lg items-center">
        ...
        <div className="my-4">
          <p className="text-sm">
            ...
            <a
              href="https://github.com/PARAGDADHICH/"
              target="_blank"
              rel="noreferrer"
              aria-label="GitHub"
        ...
        <div className="flex justify-center my-8">
          <Link href="/">
            <p className="mr-12 font-semibold text-md text-white dark:text-white bg-slate-500 ring ring-slate-600 ring-offset-2 ring-offset-slate-100 py-5 px-6 rounded-xl shadow-lg shadow-slate-500 hover:shadow-xl hover:bg-slate-600 transition duration-300 delay-40 hover:delay-40">
              Go Home
            </p>
          </Link>
          <a
